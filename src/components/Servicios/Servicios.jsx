...
function Servicios() {
  ...
  const [data, setData] = useState([
      {
          id: 1,
          titulo: 'Consultorio Veterinario las 24hs',
          icono: icono1,
          descripcion:
              'Gracias a nuestra disponibilidad 24 horas los 365 días al año,también podemos ofrecerte el servicio de internación. En nuestras instalaciones tenemos espacios diferenciados para cadanecesidad, como ser: oxigenoterapia, Unidad de Cuidados Intensivos (UCI) con espacios de internación para la comodidad  de tu mascota. Nuestro objetivo es que se sienta como en casa.',
      },
      {
          id: 2,
      ...
      },
      {
          ...
          icono: icono4,
          descripcion:
              'Farmacia abierta de Lunes a Sábado de 8 a 22 horas y Domingos de 10 a 13 y 18 a 21.Contamos con una amplia gama de medicamentos y lo que no tenemos, te lo conseguimos.Productos con gran variedad de precio y la mejor calidad. Servicio de entregas a domicilio.Laboratorio Propio de Recetas Magistrales. Vacunas, sueros , alimentos de todas las Marcas y alimentos Medicados',
      },
      {
          id: 5,
          titulo: 'Envios GRATIS en el dia',
          icono: icono5,
          descripcion:
              'Hacemos entregas GRATIS en la mayoría de CABA y Vicente Lopez ¡Consultanos por tu barrio!A parte, si haces tu pedido antes de las 16:00hs (en la mayoría de las zonas) podemos entregarlo el mismo día.Podés comprar desde tu casa en nuestra Tienda Online, Mercado Libre o Hacer tu pedido a nuestro Whatsapp y nosotros lo llevamos a donde quieras.',
      },
      {
          id: 6,
          titulo: 'Servicio de Internación',
          icono: icono6,
          descripcion:
              'Gracias a nuestra disponibilidad 24 horas los 365 días al año, también podemos ofrecerte el servicio de internación.En nuestras instalaciones tenemos espacios diferenciados para cada necesidad, como ser: oxigenoterapia, Unidad de Cuidados Intensivos (UCI) con espacios de internación para la comodidad de tu mascota.Nuestro objetivo es que se sienta como en casa',
      },
  ]);
